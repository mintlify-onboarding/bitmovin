---
title: "How do I set up CORS for my Google Cloud Storage Bucket?"
---

If you already familiar with Google Cloud Services and Tools, like gcloud and/or gsutil, you can also checkout [Google's documentation about CORS](https://cloud.google.com/storage/docs/cross-origin#Configuring-CORS-on-a-Bucket). 

Login to your google cloud console: [https://console.cloud.google.com/home](https://console.cloud.google.com/home). Click on "Activate Google Cloud Shell" in the upper right corner (see picture below):

![](/images/encoding/docs/497aec6-image.png)
